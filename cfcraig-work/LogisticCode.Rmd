...
From the output, immediately we see that `interest`, `cost`, and `year4` are significant
...
The log-odds coefficients are not intuitive, so let's convert them to odds-ratios. We'll also compute 95% confidence intervals based on profile-likelihood limits
